...
<div id="content"><?php echo $content_top; ?>
    ...
    <div class="buttons">
      <div class="left"><a onclick="$('#basket').submit();" class="button larger"><span><?php echo $button_update; ?></span></a></div>
      <div class="right"><a href="<?php echo $checkout; ?>" class="button larger"><span><?php echo $button_checkout; ?></span></a></div>
      <div class="center"><a href="<?php echo $continue; ?>" class="button larger"><span><?php echo $button_shopping; ?></span></a></div>
    </div>

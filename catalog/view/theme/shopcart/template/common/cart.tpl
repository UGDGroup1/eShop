...
<table class="cart">
  ...
  <tr>
    ...
    <td class="remove"> <a id="remove" onclick="removeCart('<?php echo $product['key']; ?>');" ></a></td>
  </tr>
  <?php } ?>
...
<table class="total">
  ...
  <?php } ?>
             ...
             ?>
 <div class="buttons">
    <a class="button" href="<?php echo HTTP_SERVER; ?>index.php?route=checkout/cart"><span class="s_text"><?php echo $text_cart; ?></span></a>

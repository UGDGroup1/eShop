...
--
-- Host: mysql02j10.db.internal
-- Generation Time: Jan 30, 2012 at 11:41 PM
...
--
-- Database: `casualde_trofej`
--

-- --------------------------------------------------------

--
-- Table structure for table `ugd_address`
--

CREATE TABLE IF NOT EXISTS `ugd_address` (
...
--
-- Dumping data for table `ugd_address`
--

INSERT INTO `ugd_address` (`address_id`, `customer_id`, `firstname`, `lastname`, `company`, `address_1`, `address_2`, `city`, `postcode`, `country_id`, `zone_id`) VALUES
(1, 1, 'Jovan', 'Krstev', 'Test', 'testte', '', 'Strumica', '2400', 126, 0);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_affiliate`
--

CREATE TABLE IF NOT EXISTS `ugd_affiliate` (
...
--
-- Table structure for table `ugd_affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `ugd_affiliate_transaction` (
...
--
-- Table structure for table `ugd_attribute`
--

CREATE TABLE IF NOT EXISTS `ugd_attribute` (
...
--
-- Dumping data for table `ugd_attribute`
--

INSERT INTO `ugd_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `ugd_attribute_description`
--

CREATE TABLE IF NOT EXISTS `ugd_attribute_description` (
...
--
-- Dumping data for table `ugd_attribute_description`
--

INSERT INTO `ugd_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Table structure for table `ugd_attribute_group`
--

CREATE TABLE IF NOT EXISTS `ugd_attribute_group` (
...
--
-- Dumping data for table `ugd_attribute_group`
--

INSERT INTO `ugd_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `ugd_attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `ugd_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `ugd_attribute_group_description`
--

INSERT INTO `ugd_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor'),
...
--
-- Table structure for table `ugd_banner`
--

CREATE TABLE IF NOT EXISTS `ugd_banner` (
...
--
-- Dumping data for table `ugd_banner`
--

INSERT INTO `ugd_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'акција', 1),
(7, 'Слајдер', 1),
(8, 'Баннерс', 1);
...
--
-- Table structure for table `ugd_banner_image`
--

CREATE TABLE IF NOT EXISTS `ugd_banner_image` (
...
--
-- Dumping data for table `ugd_banner_image`
--

INSERT INTO `ugd_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
(131, 7, 'tofej.info', 'data/слајдер/images (1).jpg'),
(138, 8, 'http://www.agrofructus.hr/', 'data/products/contact-banner.jpg'),
(137, 8, 'http://www.enzazaden.com/', 'data/banners/енза заден.jpg'),
(136, 8, 'http://www.tinex.com.mk', 'data/banners/тинекс 2.jpg'),
(135, 8, 'http://www.vitaminka.com.mk/', 'data/products/41786_50909765991_1169_n - Copy.jpg'),
(125, 6, '/index.php?route=product/manufacturer/product&amp;manufacturer_id=7', 'data/products/15233.jpg'),
(133, 8, 'www.agro-komerc92.com.mk', 'data/products/index.jpg'),
(134, 8, 'http://www.principkomerc.com.mk/', 'data/banners/princ_oliva_logo.gif'),
(126, 6, '', 'data/products/images.jpg'),
(130, 7, 'tofej.info', 'data/products/2.jpg'),
(132, 7, 'tofej.info', 'data/слајдер/15249.jpg'),
(139, 8, ' www.tiveriopol.com.mk', 'data/banners/тивериопол.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_banner_image_description`
--

CREATE TABLE IF NOT EXISTS `ugd_banner_image_description` (
...
--
-- Dumping data for table `ugd_banner_image_description`
--

INSERT INTO `ugd_banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`) VALUES
(131, 1, 7, 'Tofej'),
(139, 1, 8, 'Tiveriopol'),
(138, 2, 8, 'Агро-Фруктус'),
(138, 1, 8, 'AgroFructus'),
(137, 2, 8, 'Енза Заден'),
(126, 1, 6, 'Natural Drink'),
(125, 2, 6, 'HP Banner'),
(125, 1, 6, 'HP Banner'),
(137, 1, 8, 'Enza Zaden'),
(136, 2, 8, 'Тинекс'),
(136, 1, 8, 'Tinex'),
(135, 2, 8, 'Витаминка'),
(134, 2, 8, 'Принцип-Комерц'),
(135, 1, 8, 'Vitaminka'),
(134, 1, 8, 'PrincipKomerc'),
(133, 2, 8, 'Агро-Комерц'),
(133, 1, 8, 'Agro-Komerc'),
(126, 2, 6, 'Priroden sok'),
(130, 2, 7, 'тофеј'),
(130, 1, 7, 'tofej'),
(131, 2, 7, 'Тофеј'),
(132, 1, 7, 'Tofej'),
...
--
-- Table structure for table `ugd_category`
--

CREATE TABLE IF NOT EXISTS `ugd_category` (
...
--
-- Dumping data for table `ugd_category`
--

INSERT INTO `ugd_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
(77, 'data/categorys/images 4.jpg', 75, 0, 1, 0, 1, '2012-01-29 03:20:55', '2012-01-29 08:05:15'),
(78, 'data/categorys/images (3).jpg', 74, 0, 1, 0, 1, '2012-01-29 03:21:48', '2012-01-29 08:56:28'),
(79, 'data/categorys/download.jpg', 78, 0, 1, 0, 1, '2012-01-29 03:25:57', '2012-01-29 08:39:43'),
(80, 'data/categorys/images (8).jpg', 78, 0, 1, 0, 1, '2012-01-29 03:26:54', '2012-01-29 20:43:15'),
(76, 'data/categorys/images 20.jpg', 75, 0, 1, 0, 1, '2012-01-29 03:20:19', '2012-01-29 08:54:20'),
(68, 'data/categorys/download.jpg', 67, 0, 1, 0, 1, '2012-01-29 03:09:18', '2012-01-29 20:45:07'),
(66, 'data/categorys/images 11.jpg', 64, 0, 1, 0, 1, '2012-01-29 03:05:57', '2012-01-29 08:43:03'),
(67, 'data/categorys/images (2).jpg', 64, 0, 1, 0, 1, '2012-01-29 03:06:49', '2012-01-29 08:44:41'),
(69, 'data/categorys/images (8).jpg', 67, 0, 1, 0, 1, '2012-01-29 03:10:31', '2012-01-29 20:44:35'),
(70, 'data/categorys/images 8.jpg', 64, 0, 1, 0, 1, '2012-01-29 03:11:16', '2012-01-29 08:22:54'),
(71, 'data/categorys/images 7.jpg', 64, 0, 1, 0, 1, '2012-01-29 03:11:56', '2012-01-29 08:16:13'),
(74, 'data/categorys/images 5.jpg', 0, 1, 1, 0, 1, '2012-01-29 03:17:24', '2012-01-29 08:09:00'),
(73, 'data/categorys/images 9.jpg', 64, 0, 1, 0, 1, '2012-01-29 03:12:37', '2012-01-29 08:28:40'),
(75, 'data/categorys/image1.jpg', 74, 0, 1, 0, 1, '2012-01-29 03:18:17', '2012-01-29 20:35:58'),
(64, '', 0, 1, 1, 0, 1, '2012-01-29 03:04:23', '2012-01-29 07:43:23');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_category_description`
--

CREATE TABLE IF NOT EXISTS `ugd_category_description` (
...
--
-- Dumping data for table `ugd_category_description`
--

INSERT INTO `ugd_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(80, 2, 'Безалкохолни', '&lt;p&gt;\r\n	Безалкохолни&lt;/p&gt;\r\n', 'Безалкохолни', ''),
(74, 2, ' Продажба на големо', '&lt;p&gt;\r\n	&amp;nbsp;Продажба на големо&lt;/p&gt;\r\n', ' Продажба на големо', ' Продажба на големо'),
(66, 1, 'Food', '&lt;p&gt;\r\n	Food&lt;/p&gt;\r\n', 'Food', 'Food'),
(69, 1, 'Soft', '&lt;p&gt;\r\n	Soft&lt;/p&gt;\r\n', 'Soft', 'Soft'),
(80, 1, 'Soft', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Soft&lt;/span&gt;&lt;/p&gt;\r\n', 'Soft', 'Soft'),
(70, 2, 'Прибор за домакинство', '&lt;p&gt;\r\n	Прибор за домакинство&lt;/p&gt;\r\n', 'Прибор за домакинство', 'Прибор за домакинство'),
(66, 2, 'Храна', '&lt;p&gt;\r\n	Храна&lt;/p&gt;\r\n', 'Храна', ''),
(67, 2, 'Пијалоци', '&lt;p&gt;\r\n	Пијалоци&lt;/p&gt;\r\n', 'Пијалоци', ''),
(68, 2, 'Алкохолни', '&lt;p&gt;\r\n	Алкохолни&lt;/p&gt;\r\n', 'Алкохолни', ''),
(69, 2, 'Безалкохолни', '&lt;p&gt;\r\n	Безалкохолни&lt;/p&gt;\r\n', 'Безалкохолни', ''),
(76, 2, 'Зеленчук', '&lt;p&gt;\r\n	Зеленчук&lt;/p&gt;\r\n', 'Zelencuk', ''),
(77, 1, 'fruit', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;fruit&lt;/span&gt;&lt;/p&gt;\r\n', 'fruit', 'fruit'),
(78, 1, 'Drinks', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Drinks&lt;/span&gt;&lt;/p&gt;\r\n', 'Drinks', 'Drinks'),
(79, 2, 'Алкохолни', '&lt;p&gt;\r\n	Алкохолни&lt;/p&gt;\r\n', 'Алкохолни', ''),
(64, 1, 'Retail sales products', '&lt;p&gt;\r\n	&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Retail&lt;/span&gt;&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;sales&lt;/span&gt;&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;products&lt;/span&gt;&lt;/p&gt;\r\n', 'Retail sales products', 'Retail sales products'),
(71, 2, 'Здравје и убавина', '&lt;p&gt;\r\n	Здравје и убавина&lt;/p&gt;\r\n', 'Здравје и убавина', ''),
(73, 1, 'Action', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Action&lt;/span&gt;&lt;/p&gt;\r\n', 'Action', 'Action'),
(74, 1, 'Wholesale', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Wholesale&lt;/span&gt;&lt;/p&gt;\r\n', 'Wholesale', 'Wholesale'),
(75, 2, 'Земјоделски производи', '&lt;p&gt;\r\n	Земјоделски производи&lt;/p&gt;\r\n', 'Земјоделски производи', ''),
(77, 2, 'Овошје', '&lt;p&gt;\r\n	Овошје&lt;/p&gt;\r\n', 'Овошје', ''),
(78, 2, 'Пијалоци', '&lt;p&gt;\r\n	Пијалоци&lt;/p&gt;\r\n', 'Пијалоци', ''),
(79, 1, 'Alcohol', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Alcohol&lt;/span&gt;&lt;/p&gt;\r\n', 'Alcohol', 'Alcohol'),
(64, 2, 'Мало продажни продукти', '&lt;p&gt;\r\n	Мало продажни продукти&lt;/p&gt;\r\n', 'Мало продажни продукти', ''),
(73, 2, 'Акција', '&lt;p&gt;\r\n	Акција&lt;/p&gt;\r\n', 'Акција', ''),
(71, 1, 'Health and Beauty', '&lt;p&gt;\r\n	&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Health&lt;/span&gt;&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;and Beauty&lt;/span&gt;&lt;/p&gt;\r\n', 'Health and Beauty', 'Health and Beauty'),
(68, 1, 'Alcohol', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif; text-align: left; &quot;&gt;Alcohol&lt;/span&gt;&lt;/p&gt;\r\n', 'Alcohol', 'Alcohol'),
(75, 1, 'Agricultural products', '&lt;p&gt;\r\n	&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Agricultural&lt;/span&gt;&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;products&lt;/span&gt;&lt;/p&gt;\r\n', 'Agricultural products', 'Agricultural products'),
(67, 1, 'Drinks', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Drinks&lt;/span&gt;&lt;/p&gt;\r\n', 'Drinks', 'Drinks'),
(70, 1, 'Household utensils', '&lt;p&gt;\r\n	&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Household&lt;/span&gt;&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;span class=&quot;hps&quot; style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;utensils&lt;/span&gt;&lt;/p&gt;\r\n', 'Household utensils', 'Household utensils'),
(76, 1, 'Vegetables', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;vegetables&lt;/span&gt;&lt;/p&gt;\r\n', 'vegetables', 'vegetables');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_category_to_layout`
--

CREATE TABLE IF NOT EXISTS `ugd_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ugd_category_to_layout`
--

INSERT INTO `ugd_category_to_layout` (`category_id`, `store_id`, `layout_id`) VALUES
(64, 0, 4);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_category_to_store`
--

CREATE TABLE IF NOT EXISTS `ugd_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `ugd_category_to_store`
--

INSERT INTO `ugd_category_to_store` (`category_id`, `store_id`) VALUES
(64, 0),
(66, 0),
(67, 0),
(68, 0),
...
--
-- Table structure for table `ugd_country`
--

CREATE TABLE IF NOT EXISTS `ugd_country` (
...
--
-- Dumping data for table `ugd_country`
--

INSERT INTO `ugd_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `ugd_coupon`
--

CREATE TABLE IF NOT EXISTS `ugd_coupon` (
...
--
-- Dumping data for table `ugd_coupon`
--

INSERT INTO `ugd_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `ugd_coupon_history`
--

CREATE TABLE IF NOT EXISTS `ugd_coupon_history` (
...
--
-- Table structure for table `ugd_coupon_product`
--

CREATE TABLE IF NOT EXISTS `ugd_coupon_product` (
...
--
-- Table structure for table `ugd_currency`
--

CREATE TABLE IF NOT EXISTS `ugd_currency` (
...
--
-- Dumping data for table `ugd_currency`
--

INSERT INTO `ugd_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.01360000, 1, '2012-01-30 04:03:45'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.02130000, 1, '2012-01-30 09:56:18'),
(3, 'Euro', 'EUR', '', '€', '2', 0.01620000, 1, '2012-01-30 04:03:45'),
(4, 'MKD', 'MKD', '', ' ден.', '0', 1.00000000, 1, '2012-01-30 14:56:26');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_customer`
--

CREATE TABLE IF NOT EXISTS `ugd_customer` (
...
--
-- Dumping data for table `ugd_customer`
--

INSERT INTO `ugd_customer` (`customer_id`, `store_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `cart`, `wishlist`, `newsletter`, `address_id`, `customer_group_id`, `ip`, `status`, `approved`, `token`, `date_added`) VALUES
(1, 0, 'Jovan', 'Krstev', 'krstevjohn@gmail.com', '8976760075', '', '6f64a8c8626f42ab2032a960232f047c', 'a:1:{i:52;i:1;}', '', 0, 1, 8, '192.168.1.102', 1, 1, '', '2012-01-29 05:16:17');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_customer_group`
--

CREATE TABLE IF NOT EXISTS `ugd_customer_group` (
...
--
-- Dumping data for table `ugd_customer_group`
--

INSERT INTO `ugd_customer_group` (`customer_group_id`, `name`) VALUES
(8, 'Default'),
(6, 'Wholesale');
...
--
-- Table structure for table `ugd_customer_ip`
--

CREATE TABLE IF NOT EXISTS `ugd_customer_ip` (
...
--
-- Dumping data for table `ugd_customer_ip`
--

INSERT INTO `ugd_customer_ip` (`customer_ip_id`, `customer_id`, `ip`, `date_added`) VALUES
(1, 1, '192.168.1.102', '2012-01-29 05:16:17'),
(2, 1, '192.168.1.101', '2012-01-29 07:30:29');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_customer_reward`
--

CREATE TABLE IF NOT EXISTS `ugd_customer_reward` (
...
--
-- Table structure for table `ugd_customer_transaction`
--

CREATE TABLE IF NOT EXISTS `ugd_customer_transaction` (
...
--
-- Table structure for table `ugd_download`
--

CREATE TABLE IF NOT EXISTS `ugd_download` (
...
--
-- Table structure for table `ugd_download_description`
--

CREATE TABLE IF NOT EXISTS `ugd_download_description` (
...
--
-- Table structure for table `ugd_extension`
--

CREATE TABLE IF NOT EXISTS `ugd_extension` (
...
--
-- Dumping data for table `ugd_extension`
--

INSERT INTO `ugd_extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Table structure for table `ugd_geo_zone`
--

CREATE TABLE IF NOT EXISTS `ugd_geo_zone` (
...
--
-- Dumping data for table `ugd_geo_zone`
--

INSERT INTO `ugd_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Table structure for table `ugd_information`
--

CREATE TABLE IF NOT EXISTS `ugd_information` (
...
--
-- Dumping data for table `ugd_information`
--

INSERT INTO `ugd_information` (`information_id`, `sort_order`, `status`) VALUES
(3, 3, 1),
(4, 1, 1),
(5, 4, 1),
(6, 2, 1);
...
--
-- Table structure for table `ugd_information_description`
--

CREATE TABLE IF NOT EXISTS `ugd_information_description` (
...
--
-- Dumping data for table `ugd_information_description`
--

INSERT INTO `ugd_information_description` (`information_id`, `language_id`, `title`, `description`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n'),
...
--
-- Table structure for table `ugd_information_to_layout`
--

CREATE TABLE IF NOT EXISTS `ugd_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Table structure for table `ugd_information_to_store`
--

CREATE TABLE IF NOT EXISTS `ugd_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `ugd_information_to_store`
--

INSERT INTO `ugd_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Table structure for table `ugd_language`
--

CREATE TABLE IF NOT EXISTS `ugd_language` (
...
--
-- Dumping data for table `ugd_language`
--

INSERT INTO `ugd_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
(1, 'English', 'en', 'en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 'english', 1, 1),
(2, 'Macedonian', 'mk', 'mk_MK.UTF-8,mk_MK,macedonian', 'mk.png', 'macedonian', 'macedonian', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_layout`
--

CREATE TABLE IF NOT EXISTS `ugd_layout` (
...
--
-- Dumping data for table `ugd_layout`
--

INSERT INTO `ugd_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `ugd_layout_route`
--

CREATE TABLE IF NOT EXISTS `ugd_layout_route` (
...
--
-- Dumping data for table `ugd_layout_route`
--

INSERT INTO `ugd_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(30, 6, 0, 'account'),
(17, 10, 0, 'affiliate/'),
...
--
-- Table structure for table `ugd_length_class`
--

CREATE TABLE IF NOT EXISTS `ugd_length_class` (
...
--
-- Dumping data for table `ugd_length_class`
--

INSERT INTO `ugd_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `ugd_length_class_description`
--

CREATE TABLE IF NOT EXISTS `ugd_length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ugd_length_class_description`
--

INSERT INTO `ugd_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in'),
(1, 2, 'Centimeter', 'cm'),
...
--
-- Table structure for table `ugd_manufacturer`
--

CREATE TABLE IF NOT EXISTS `ugd_manufacturer` (
...
--
-- Dumping data for table `ugd_manufacturer`
--

INSERT INTO `ugd_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `ugd_manufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `ugd_manufacturer_to_store` (
...
--
-- Dumping data for table `ugd_manufacturer_to_store`
--

INSERT INTO `ugd_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `ugd_option`
--

CREATE TABLE IF NOT EXISTS `ugd_option` (
...
--
-- Dumping data for table `ugd_option`
--

INSERT INTO `ugd_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
--
-- Table structure for table `ugd_option_description`
--

CREATE TABLE IF NOT EXISTS `ugd_option_description` (
...
--
-- Dumping data for table `ugd_option_description`
--

INSERT INTO `ugd_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Table structure for table `ugd_option_value`
--

CREATE TABLE IF NOT EXISTS `ugd_option_value` (
...
--
-- Dumping data for table `ugd_option_value`
--

INSERT INTO `ugd_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `ugd_option_value_description`
--

CREATE TABLE IF NOT EXISTS `ugd_option_value_description` (
...
--
-- Dumping data for table `ugd_option_value_description`
--

INSERT INTO `ugd_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Table structure for table `ugd_order`
--

CREATE TABLE IF NOT EXISTS `ugd_order` (
...
--
-- Dumping data for table `ugd_order`
--

INSERT INTO `ugd_order` (`order_id`, `invoice_no`, `invoice_prefix`, `store_id`, `store_name`, `store_url`, `customer_id`, `customer_group_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `shipping_firstname`, `shipping_lastname`, `shipping_company`, `shipping_address_1`, `shipping_address_2`, `shipping_city`, `shipping_postcode`, `shipping_country`, `shipping_country_id`, `shipping_zone`, `shipping_zone_id`, `shipping_address_format`, `shipping_method`, `payment_firstname`, `payment_lastname`, `payment_company`, `payment_address_1`, `payment_address_2`, `payment_city`, `payment_postcode`, `payment_country`, `payment_country_id`, `payment_zone`, `payment_zone_id`, `payment_address_format`, `payment_method`, `comment`, `total`, `reward`, `order_status_id`, `affiliate_id`, `commission`, `language_id`, `currency_id`, `currency_code`, `currency_value`, `date_added`, `date_modified`, `ip`) VALUES
(1, 0, 'INV-2011-00', 0, 'Your Store', 'http://192.168.1.102/eshop/', 1, 8, 'Jovan', 'Krstev', 'krstevjohn@gmail.com', '8976760075', '', 'Jovan', 'Krstev', 'Test', 'testte', '', 'Strumica', '2400', 'Macedonia', 126, '', 0, '', 'Flat Shipping Rate', 'Jovan', 'Krstev', 'Test', 'testte', '', 'Strumica', '2400', 'Macedonia', 126, '', 0, '', 'Cash On Delivery', 'dasd', '1355.0000', 0, 1, 0, '0.0000', 1, 3, 'EUR', '0.70660001', '2012-01-29 21:30:28', '2012-01-29 21:30:30', '192.168.1.102');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_order_download`
--

CREATE TABLE IF NOT EXISTS `ugd_order_download` (
...
--
-- Table structure for table `ugd_order_history`
--

CREATE TABLE IF NOT EXISTS `ugd_order_history` (
...
--
-- Dumping data for table `ugd_order_history`
--

INSERT INTO `ugd_order_history` (`order_history_id`, `order_id`, `order_status_id`, `notify`, `comment`, `date_added`) VALUES
(1, 1, 1, 1, '', '2012-01-29 21:30:30');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_order_option`
--

CREATE TABLE IF NOT EXISTS `ugd_order_option` (
...
--
-- Table structure for table `ugd_order_product`
--

CREATE TABLE IF NOT EXISTS `ugd_order_product` (
...
--
-- Dumping data for table `ugd_order_product`
--

INSERT INTO `ugd_order_product` (`order_product_id`, `order_id`, `product_id`, `name`, `model`, `quantity`, `price`, `total`, `tax`) VALUES
(1, 1, 51, 'Potatoes', 'Компир', 1, '25.0000', '25.0000', '0.0000'),
(2, 1, 56, 'Cabbage', 'Зелка', 85, '13.0000', '1105.0000', '0.0000'),
(3, 1, 55, 'Bananas ', 'Банани', 4, '55.0000', '220.0000', '0.0000');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_order_status`
--

CREATE TABLE IF NOT EXISTS `ugd_order_status` (
...
--
-- Dumping data for table `ugd_order_status`
--

INSERT INTO `ugd_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `ugd_order_total`
--

CREATE TABLE IF NOT EXISTS `ugd_order_total` (
...
--
-- Dumping data for table `ugd_order_total`
--

INSERT INTO `ugd_order_total` (`order_total_id`, `order_id`, `code`, `title`, `text`, `value`, `sort_order`) VALUES
(1, 1, 'sub_total', 'Sub-Total', '953.91€', '1350.0000', 1),
(2, 1, 'shipping', 'Flat Shipping Rate', '3.53€', '5.0000', 3),
(3, 1, 'total', 'Total', '957.44€', '1355.0000', 9);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product`
--

CREATE TABLE IF NOT EXISTS `ugd_product` (
...
--
-- Dumping data for table `ugd_product`
--

INSERT INTO `ugd_product` (`product_id`, `model`, `sku`, `upc`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `date_added`, `date_modified`, `viewed`) VALUES
(30, 'Бен квик', '', '', 'струмица', 50, 6, 'data/products/IMAG0383.jpg', 0, 1, '110.0000', 0, 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 0, 1, '2009-02-03 16:59:00', '2012-01-29 08:51:42', 0),
(59, 'Биоактив ', '', '', 'струмица', 30, 5, 'data/products/IMAG0384.jpg', 0, 1, '225.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:54:19', '0000-00-00 00:00:00', 0),
(50, 'Шеќер', '', '', 'Битолски', 2500, 5, 'data/products/IMAG0380.jpg', 0, 0, '50.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 02:19:32', '2012-01-29 08:40:22', 0),
(51, 'Компир', '', '', 'струмица', 9999, 5, 'data/products/IMAG0293.jpg', 0, 1, '25.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 07:43:00', '2012-01-29 08:26:33', 0),
(52, 'Портокали', '', '', 'струмица', 10000, 5, 'data/products/IMAG0294.jpg', 0, 1, '52.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 07:50:41', '2012-01-29 08:18:51', 2),
(53, 'Мандарини', '', '', 'струмица', 7000, 5, 'data/products/IMAG0296.jpg', 0, 1, '45.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 07:54:20', '2012-01-29 08:23:23', 0),
(54, 'Кромид', '', '', 'струмица', 15000, 5, 'data/products/IMAG0295.jpg', 0, 1, '15.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 07:59:17', '2012-01-29 08:24:49', 4),
(55, 'Банани', '', '', '', 1996, 5, 'data/products/IMAG0291.jpg', 0, 1, '55.0000', 0, 9, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:02:38', '2012-01-29 08:39:35', 0),
(56, 'Зелка', '', '', 'струмица', 19915, 5, 'data/products/IMAG0381.jpg', 0, 1, '13.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:08:15', '0000-00-00 00:00:00', 4),
(57, 'Чоколадо', '', '', '', 100, 5, 'data/products/IMAG0374.jpg', 0, 1, '35.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:30:49', '0000-00-00 00:00:00', 0),
(58, 'Колачињата', '', '', '', 150, 5, 'data/products/IMAG0375.jpg', 0, 1, '20.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:35:22', '2012-01-29 08:37:25', 0),
(47, 'Елит кафе + подарок', '', '', 'струмица', 1000, 5, 'data/products/IMAG0382.jpg', 0, 1, '155.0000', 400, 9, '2009-02-03', '1.00', 1, '0.00', '0.00', '0.00', 1, 0, 1, 0, 1, '2009-02-03 21:08:40', '2012-01-29 08:42:45', 0),
(60, 'Сапун за раце', '', '', 'струмица', 30, 5, 'data/products/IMAG0385.jpg', 0, 1, '20.0000', 0, 0, '2012-01-28', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, '2012-01-29 08:57:04', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product_attribute`
--

CREATE TABLE IF NOT EXISTS `ugd_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ugd_product_attribute`
--

INSERT INTO `ugd_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(47, 4, 2, '16GB'),
(47, 4, 1, '16GB'),
(47, 2, 1, '4'),
(47, 2, 2, '4');
...
--
-- Table structure for table `ugd_product_description`
--

CREATE TABLE IF NOT EXISTS `ugd_product_description` (
  `product_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `ugd_product_description`
--

INSERT INTO `ugd_product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(50, 1, 'Sugar', '&lt;p&gt;\r\n	Sugar (Bitolski)&amp;nbsp;&lt;/p&gt;\r\n', 'Sugar', 'Sugar'),
(50, 2, 'Шеќер', '&lt;p&gt;\r\n	Шеќер (Битолски)&lt;/p&gt;\r\n', 'Шеќер', 'Шеќер'),
(47, 1, 'Ellite cafe + Gift', '&lt;p&gt;\r\n	Ellite cafe + Gifts&lt;/p&gt;\r\n', 'Ellite cafe + Gift', 'Ellite cafe + Gift'),
(47, 2, 'Елит кафе + подарок', '&lt;p&gt;\r\n	Елит кафе + подарок&lt;/p&gt;\r\n', 'Елит кафе + подарок', 'Елит кафе + подарок'),
(30, 1, 'Ben Quik', '&lt;p&gt;\r\n	Ben Quik&lt;/p&gt;\r\n', 'Ben Quik', 'Ben Quik'),
(30, 2, 'Бен квик', '&lt;p&gt;\r\n	Бен квик&lt;/p&gt;\r\n', 'Бен квик', 'Бен квик'),
(59, 1, 'Bio Active', '&lt;p&gt;\r\n	Bio Active&lt;/p&gt;\r\n', 'Bio Active', 'Bio Active'),
(59, 2, 'Биоактив', '&lt;p&gt;\r\n	Биоактив&amp;nbsp;&lt;/p&gt;\r\n', 'Биоактив', 'Биоактив'),
(60, 1, 'Toilet soap', '&lt;p&gt;\r\n	Toilet soap&lt;/p&gt;\r\n', 'Toilet soap', 'Toilet soap'),
(60, 2, 'Сапун за раце', '&lt;p&gt;\r\n	Сапун за раце&lt;/p&gt;\r\n', 'Сапун за раце', 'Сапун за раце'),
(51, 2, 'Компир', '&lt;p&gt;\r\n	Струмучки компир&lt;/p&gt;\r\n', 'Компир', 'Компир'),
(51, 1, 'Potatoes', '&lt;p&gt;\r\n	&amp;nbsp; Potatoes (струмица)&lt;/p&gt;\r\n', 'Potatoes', 'Potatoes'),
(52, 1, 'Oranges', '&lt;p&gt;\r\n	&amp;nbsp; Macedonian Oranges&amp;nbsp;&lt;/p&gt;\r\n', 'oranges', 'oranges'),
(52, 2, 'Портокали', '&lt;p&gt;\r\n	Портокали Струмички&lt;/p&gt;\r\n', 'Портокали', 'Портокали'),
(53, 1, 'Тangerines', '&lt;p&gt;\r\n	Greek&amp;nbsp;Тangerines&lt;/p&gt;\r\n', 'Тangerines', 'Тangerines'),
(53, 2, 'Мандарини', '&lt;p&gt;\r\n	Мандарини Грчки&lt;/p&gt;\r\n', 'Мандарини', 'Мандарини'),
(54, 1, 'Оnion', '&lt;p&gt;\r\n	Gevgelijan Onion&lt;/p&gt;\r\n', 'Оnion', 'Оnion'),
(54, 2, 'Кромид', '&lt;p&gt;\r\n	Струмички кромид&lt;/p&gt;\r\n', 'Кромид', 'Кромид'),
(55, 2, 'Банани', '&lt;p&gt;\r\n	Банани&lt;/p&gt;\r\n', 'Банани', 'Банани'),
...
(56, 1, 'Cabbage', '&lt;p&gt;\r\n	Cabbage strmuca&lt;/p&gt;\r\n', 'Cabbage', 'Cabbage'),
(56, 2, 'Зелка', '&lt;p&gt;\r\n	&amp;nbsp;Струмицачка Зелка&amp;nbsp;&lt;/p&gt;\r\n', 'Зелка', 'Зелка'),
(57, 1, 'Chocolate', '&lt;p&gt;\r\n	Chocolate Fin Care&lt;/p&gt;\r\n', 'Chocolate', 'Chocolate'),
(57, 2, 'Чоколадо', '&lt;p&gt;\r\n	Чоколадо фин кеир&lt;/p&gt;\r\n', 'Чоколадо', 'Чоколадо'),
(58, 1, 'Cookies', '&lt;p&gt;\r\n	Cookies (Resana)&amp;nbsp;&lt;/p&gt;\r\n', 'Cookies', 'Cookies'),
(58, 2, 'Колачињата', '&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 24px; background-color: rgb(245, 245, 245); &quot;&gt;Колачињата (ресана)&amp;nbsp;&lt;/span&gt;&lt;/p&gt;\r\n', 'Колачињата', 'Колачињата');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product_discount`
--

CREATE TABLE IF NOT EXISTS `ugd_product_discount` (
...
--
-- Table structure for table `ugd_product_image`
--

CREATE TABLE IF NOT EXISTS `ugd_product_image` (
  `product_image_id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  `image` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `sort_order` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_image_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2371 ;

--
-- Dumping data for table `ugd_product_image`
--

INSERT INTO `ugd_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
(2370, 47, 'data/hp_2.jpg', 0),
(2366, 51, 'data/products/IMAG0293.jpg', 0),
(2362, 53, 'data/products/IMAG0296.jpg', 0),
(2369, 47, 'data/hp_3.jpg', 0),
(2368, 55, 'data/products/IMAG0288.jpg', 0),
(2367, 55, 'data/products/IMAG0289.jpg', 0),
(2365, 54, 'data/products/IMAG0295.jpg', 0),
(2358, 52, 'data/products/IMAG0294.jpg', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product_option`
--

CREATE TABLE IF NOT EXISTS `ugd_product_option` (
...
--
-- Dumping data for table `ugd_product_option`
--

INSERT INTO `ugd_product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`) VALUES
...
--
-- Table structure for table `ugd_product_option_value`
--

CREATE TABLE IF NOT EXISTS `ugd_product_option_value` (
...
--
-- Table structure for table `ugd_product_related`
--

CREATE TABLE IF NOT EXISTS `ugd_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `ugd_product_reward`
--

CREATE TABLE IF NOT EXISTS `ugd_product_reward` (
...
--
-- Dumping data for table `ugd_product_reward`
--

INSERT INTO `ugd_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(602, 47, 6, 30),
(601, 47, 8, 300),
(608, 60, 6, 0),
(607, 60, 8, 0),
...
--
-- Table structure for table `ugd_product_special`
--

CREATE TABLE IF NOT EXISTS `ugd_product_special` (
...
--
-- Table structure for table `ugd_product_tag`
--

CREATE TABLE IF NOT EXISTS `ugd_product_tag` (
  ...
  KEY `tag` (`tag`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=347 ;

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product_to_category`
--

CREATE TABLE IF NOT EXISTS `ugd_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ugd_product_to_category`
--

INSERT INTO `ugd_product_to_category` (`product_id`, `category_id`) VALUES
(30, 64),
(30, 66),
(47, 64),
(47, 73),
...
--
-- Table structure for table `ugd_product_to_download`
--

CREATE TABLE IF NOT EXISTS `ugd_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Table structure for table `ugd_product_to_layout`
--

CREATE TABLE IF NOT EXISTS `ugd_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ugd_product_to_layout`
--

INSERT INTO `ugd_product_to_layout` (`product_id`, `store_id`, `layout_id`) VALUES
(50, 0, 4);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_product_to_store`
--

CREATE TABLE IF NOT EXISTS `ugd_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `ugd_product_to_store`
--

INSERT INTO `ugd_product_to_store` (`product_id`, `store_id`) VALUES
(30, 0),
(47, 0),
(50, 0),
(51, 0),
...
--
-- Table structure for table `ugd_return`
--

CREATE TABLE IF NOT EXISTS `ugd_return` (
...
--
-- Table structure for table `ugd_return_action`
--

CREATE TABLE IF NOT EXISTS `ugd_return_action` (
...
--
-- Dumping data for table `ugd_return_action`
--

INSERT INTO `ugd_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `ugd_return_history`
--

CREATE TABLE IF NOT EXISTS `ugd_return_history` (
...
--
-- Table structure for table `ugd_return_product`
--

CREATE TABLE IF NOT EXISTS `ugd_return_product` (
...
--
-- Table structure for table `ugd_return_reason`
--

CREATE TABLE IF NOT EXISTS `ugd_return_reason` (
...
--
-- Dumping data for table `ugd_return_reason`
--

INSERT INTO `ugd_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `ugd_return_status`
--

CREATE TABLE IF NOT EXISTS `ugd_return_status` (
...
--
-- Dumping data for table `ugd_return_status`
--

INSERT INTO `ugd_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `ugd_review`
--

CREATE TABLE IF NOT EXISTS `ugd_review` (
...
--
-- Table structure for table `ugd_setting`
--

CREATE TABLE IF NOT EXISTS `ugd_setting` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=25439 ;

--
-- Dumping data for table `ugd_setting`
--

INSERT INTO `ugd_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
...
(25436, 0, 'config', 'config_error_filename', 'error.txt', 0),
(25435, 0, 'config', 'config_error_log', '1', 0),
(25434, 0, 'config', 'config_error_display', '1', 0),
(25433, 0, 'config', 'config_compression', '0', 0),
(25432, 0, 'config', 'config_encryption', '12345', 0),
(25431, 0, 'config', 'config_maintenance', '0', 0),
(13801, 0, 'coupon', 'coupon_sort_order', '4', 0),
(13800, 0, 'coupon', 'coupon_status', '1', 0),
(25430, 0, 'config', 'config_seo_url', '0', 0),
(25429, 0, 'config', 'config_use_ssl', '0', 0),
...
(25426, 0, 'config', 'config_alert_mail', '0', 0),
(25427, 0, 'config', 'config_account_mail', '0', 0),
(25425, 0, 'config', 'config_smtp_timeout', '5', 0),
(25424, 0, 'config', 'config_smtp_port', '25', 0),
...
(25419, 0, 'config', 'config_mail_protocol', 'mail', 0),
(25418, 0, 'config', 'config_image_cart_height', '80', 0),
...
(25417, 0, 'config', 'config_image_cart_width', '80', 0),
(25416, 0, 'config', 'config_image_wishlist_height', '50', 0),
(25415, 0, 'config', 'config_image_wishlist_width', '50', 0),
(25414, 0, 'config', 'config_image_compare_height', '90', 0),
(25413, 0, 'config', 'config_image_compare_width', '90', 0),
(25412, 0, 'config', 'config_image_related_height', '80', 0),
(25411, 0, 'config', 'config_image_related_width', '80', 0),
(25410, 0, 'config', 'config_image_additional_height', '74', 0),
(25409, 0, 'config', 'config_image_additional_width', '74', 0),
(25408, 0, 'config', 'config_image_product_height', '80', 0),
(25407, 0, 'config', 'config_image_product_width', '80', 0),
(25406, 0, 'config', 'config_image_popup_height', '500', 0),
(25405, 0, 'config', 'config_image_popup_width', '500', 0),
(25404, 0, 'config', 'config_image_thumb_height', '228', 0),
(25403, 0, 'config', 'config_image_thumb_width', '228', 0),
(25402, 0, 'config', 'config_image_category_height', '80', 0),
(25401, 0, 'config', 'config_image_category_width', '80', 0),
(25400, 0, 'config', 'config_icon', 'data/cart.png', 0),
(25398, 0, 'config', 'config_cart_weight', '1', 0),
(25399, 0, 'config', 'config_logo', 'data/logo/logo2.jpg', 0),
(25396, 0, 'config', 'config_download', '1', 0),
(16017, 0, 'voucher', 'voucher_sort_order', '8', 0),
(16016, 0, 'voucher', 'voucher_status', '1', 0),
(25397, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(25395, 0, 'config', 'config_review_status', '1', 0),
(25394, 0, 'config', 'config_return_status_id', '2', 0),
(25393, 0, 'config', 'config_complete_status_id', '5', 0),
(25392, 0, 'config', 'config_order_status_id', '1', 0),
(19410, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(19409, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(25391, 0, 'config', 'config_stock_status_id', '5', 0),
(25390, 0, 'config', 'config_stock_checkout', '0', 0),
(25438, 0, 'slideshow', 'slideshow_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"7";s:5:"width";s:3:"970";s:6:"height";s:3:"280";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}}', 1),
...
(25389, 0, 'config', 'config_stock_warning', '0', 0),
(25388, 0, 'config', 'config_stock_display', '1', 0),
(25387, 0, 'config', 'config_commission', '5', 0),
(25386, 0, 'config', 'config_affiliate_id', '4', 0),
(25385, 0, 'config', 'config_checkout_id', '5', 0),
(25384, 0, 'config', 'config_account_id', '3', 0),
(25383, 0, 'config', 'config_guest_checkout', '1', 0),
(25382, 0, 'config', 'config_customer_approval', '0', 0),
(25381, 0, 'config', 'config_customer_price', '0', 0),
(25380, 0, 'config', 'config_customer_group_id', '8', 0),
(25379, 0, 'config', 'config_invoice_prefix', 'INV-2011-00', 0),
(25378, 0, 'config', 'config_tax_customer', 'shipping', 0),
(25377, 0, 'config', 'config_tax_default', 'shipping', 0),
(25376, 0, 'config', 'config_tax', '1', 0),
(25375, 0, 'config', 'config_admin_limit', '20', 0),
(25373, 0, 'config', 'config_weight_class_id', '1', 0),
(25374, 0, 'config', 'config_catalog_limit', '15', 0),
(25372, 0, 'config', 'config_length_class_id', '1', 0),
(25371, 0, 'config', 'config_currency_auto', '1', 0),
(25370, 0, 'config', 'config_currency', 'MKD', 0),
(25369, 0, 'config', 'config_admin_language', 'en', 0),
(25367, 0, 'config', 'config_zone_id', '0', 0),
(25368, 0, 'config', 'config_language', 'mk', 0),
(25366, 0, 'config', 'config_country_id', '126', 0),
(25365, 0, 'config', 'config_layout_id', '1', 0),
(25364, 0, 'config', 'config_template', 'shopcart', 0),
(25363, 0, 'config', 'config_meta_description', 'UGD sShop Trofej', 0),
(25362, 0, 'config', 'config_title', 'eShop Trofej - UGD', 0),
(25361, 0, 'config', 'config_fax', '+389 32 390 700', 0),
(25360, 0, 'config', 'config_telephone', '+389 32 550 000', 0),
(25359, 0, 'config', 'config_email', 'nace.janev@gmail.com', 0),
(25358, 0, 'config', 'config_address', '„Крсте Мисирков“ бб п.фах 201\r\nШтип\r\n2000\r\nМакедонија', 0),
(25356, 0, 'config', 'config_name', 'eShop Трофеј', 0),
(25357, 0, 'config', 'config_owner', 'УГД', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ugd_stock_status`
--

CREATE TABLE IF NOT EXISTS `ugd_stock_status` (
...
--
-- Dumping data for table `ugd_stock_status`
--

INSERT INTO `ugd_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2 - 3 Days'),
...
--
-- Table structure for table `ugd_store`
--

CREATE TABLE IF NOT EXISTS `ugd_store` (
...
--
-- Table structure for table `ugd_tax_class`
--

CREATE TABLE IF NOT EXISTS `ugd_tax_class` (
...
--
-- Dumping data for table `ugd_tax_class`
--

INSERT INTO `ugd_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ugd_tax_rate`
--

CREATE TABLE IF NOT EXISTS `ugd_tax_rate` (
...
--
-- Dumping data for table `ugd_tax_rate`
--

INSERT INTO `ugd_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ugd_tax_rate_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `ugd_tax_rate_to_customer_group` (
...
--
-- Dumping data for table `ugd_tax_rate_to_customer_group`
--

INSERT INTO `ugd_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 6),
(86, 8),
(87, 6),
(87, 8);
...
--
-- Table structure for table `ugd_tax_rule`
--

CREATE TABLE IF NOT EXISTS `ugd_tax_rule` (
...
--
-- Dumping data for table `ugd_tax_rule`
--

INSERT INTO `ugd_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Table structure for table `ugd_url_alias`
--

CREATE TABLE IF NOT EXISTS `ugd_url_alias` (
...
--
-- Dumping data for table `ugd_url_alias`
--

INSERT INTO `ugd_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `ugd_user`
--

CREATE TABLE IF NOT EXISTS `ugd_user` (
...
--
-- Dumping data for table `ugd_user`
--

INSERT INTO `ugd_user` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', 'nace.janev@gmail.com', '', '146.255.80.77', 1, '2012-01-29 01:19:11');

-- --------------------------------------------------------

--
-- Table structure for table `ugd_user_group`
--

CREATE TABLE IF NOT EXISTS `ugd_user_group` (
...
--
-- Dumping data for table `ugd_user_group`
--

INSERT INTO `ugd_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `ugd_voucher`
--

CREATE TABLE IF NOT EXISTS `ugd_voucher` (
...
--
-- Table structure for table `ugd_voucher_history`
--

CREATE TABLE IF NOT EXISTS `ugd_voucher_history` (
...
--
-- Table structure for table `ugd_voucher_theme`
--

CREATE TABLE IF NOT EXISTS `ugd_voucher_theme` (
...
--
-- Dumping data for table `ugd_voucher_theme`
--

INSERT INTO `ugd_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `ugd_voucher_theme_description`
--

CREATE TABLE IF NOT EXISTS `ugd_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `ugd_voucher_theme_description`
--

INSERT INTO `ugd_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General'),
(6, 2, 'Christmas'),
...
--
-- Table structure for table `ugd_weight_class`
--

CREATE TABLE IF NOT EXISTS `ugd_weight_class` (
...
--
-- Dumping data for table `ugd_weight_class`
--

INSERT INTO `ugd_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `ugd_weight_class_description`
--

CREATE TABLE IF NOT EXISTS `ugd_weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `ugd_weight_class_description`
--

INSERT INTO `ugd_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz'),
...
--
-- Table structure for table `ugd_zone`
--

CREATE TABLE IF NOT EXISTS `ugd_zone` (
...
--
-- Dumping data for table `ugd_zone`
--

INSERT INTO `ugd_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
--
-- Table structure for table `ugd_zone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `ugd_zone_to_geo_zone` (
...
--
-- Dumping data for table `ugd_zone_to_geo_zone`
--

INSERT INTO `ugd_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
